...
const GameScreen = (props) => {
    ...
    //shadow step: get one more turn
    socket.on("extra_turn", ({ playerId }) => {
        console.log("EXTRA TURN:", playerId);
        setCurrentTurn(playerId);
    });

    socket.on("current_turn", (player) => {
        console.log("CURRENT TURN:", player.userId);
        setCurrentTurn(player.userId);
    });
                                                ...
                                                <AvatarTimer
                                                    ...
                                                    onComplete={() => {
                                                        const availableNumbers =
                                                            playerBoards[player.userId]?.filter(
